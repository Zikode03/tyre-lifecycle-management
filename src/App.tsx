  ...
  return (
    <Routes>
      ...
      <Route element={<AppShell />}>
        ...
        <Route path="/vehicles/:vehicleId" element={<VehicleWorkspacePage />} />
        <Route path="/tyres" element={<TyresPage />} />
        <Route path="/tyres/fitment/new" element={<TyreFitmentPage />} />
        <Route path="/tyres/:tyreId" element={<TyrePassportPage />} />
        <Route path="/inspections" element={<InspectionsPage />} />
        <Route path="/inspections/:inspectionId" element={<InspectionWorkspacePage />} />
        <Route path="/bookings" element={<BookingsPage />} />
        <Route path="/bookings/:bookingId" element={<BookingWorkspacePage />} />
        <Route path="/warranty" element={<WarrantyPage />} />
        <Route path="/warranty/:claimId" element={<WarrantyClaimPage />} />
