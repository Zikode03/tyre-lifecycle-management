  ...
  return (
    <div className="relative mx-auto flex h-[420px] w-full max-w-[560px] items-center justify-center" aria-hidden="true">
      ...
      <svg viewBox="0 0 560 420" className="relative z-10 h-full w-full overflow-visible">
        ...
        <ellipse cx="280" cy="347" rx="154" ry="24" fill="#000" opacity="0.34" />
        ...
        <g filter="url(#tyre-shadow)" transform="rotate(-10 280 210)">
          ...
          {/* Signature orange lifecycle ring */}
          <path
            d="M174 119c24-37 63-60 107-60 41 0 79 20 103 53"
            fill="none"
            stroke="#F97316"
            strokeWidth="7"
            strokeLinecap="round"
        ...
        {/* Floating data cards make the graphic feel like tyre software, not just automotive imagery. */}
